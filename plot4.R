...
## Plot 1/4
plot(data$Global_active_power, type="n", xlab="", xaxt="n", ylab="Global Active Power")
axis(1, at = c(0,(0.5*length(data$Date)),length(data$Date)), labels=c("Thu", "Fri", "Sat"))
# add the lines
lines(data$Global_active_power, type = "l")

## Plot 2/4
# start with a blank window, type="n"
...
legend("topright", c("Sub_metering_1", "Sub_metering_2", "Sub_metering_3"), lwd=1, lty=c(1), col=c("black", "red", "blue"), bty="n")
